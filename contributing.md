# Contributing to go-rbac

First and foremost, thank you! We appreciate that you want to contribute to go-rbac, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for go-rbac**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for go-rbac:

- star the [project](https://github.com/WindomZ/go-rbac)
- tweet your support for go-rbac
...
- **version**: please note the version of go-rbac are you using
...
[so]: http://stackoverflow.com/questions/tagged/go-rbac